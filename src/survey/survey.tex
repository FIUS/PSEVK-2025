...
\end{figure}
\section*{\LARGE Feedback - PSE Vorkurs 2025}
\vspace{1cm}

\begin{tabular}{p{5.6cm}p{1.8cm}p{1.8cm}p{2.3cm}p{1.8cm}p{1.8cm}p{0.001cm}}
  Ich war überwiegend im Seminarraum... & $\Box$ 0.108 & $\Box$ 0.124 & $\Box$ GS-Pool \\
                           & $\Box$ 0.363 & $\Box$ 0.447
\end{tabular}
...
\\
\\
\begin{tabular}{p{8.5cm}C{2.1cm}C{2.1cm}C{2.1cm}p{0.001cm}}
                                                                             & besser & gleich gut & schlechter \\
  Ich fand die Erklärungen der gleichen Themen ... als im MINT-Vorkurs & $\Box$ & $\Box$     & $\Box$
\end{tabular}
...
\vertikalblockfour{vollständig}{eher ja}{eher nein}{gar nicht}{
  \blocktextfour{Variablen, Datentypen und Prints}
  \blocktextfour{Boolean, If, While und For Schleifen}
  \blocktextfour{Funktionen und Arrays}
  \blocktextfour{Klassen und Objekte}
  \blocktextfour{Datenstrukturen}
}
