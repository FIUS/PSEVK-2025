...
In der Highperformer Aufgabe heute geht es um die Erfüllbarkeit von Formeln. Eine Formel ist ein Boole'scher Ausdruck. Wenn es mit irgendeiner Belegung der Variablen möglich ist, dass die Formel insgesamt \texttt{true} wird, dann ist die Formel erfüllbar.
\\\\
Man unterteilt Formen in immer Wahr (Tautologien), immer Falsch sind (Unerfüllbar) oder manchmal Wahr und manchmal Falsch (Erfüllbar):
\\\\
