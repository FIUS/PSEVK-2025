...
\begin{frame}[fragile]
  ...
  Nun schreiben wir folgenden Code in die \texttt{Main}-Klasse
  \begin{minted}{java}
    public class Main {
...
\begin{frame}
  \frametitle{Erste Java Klasse}
  \begin{itemize}
    \item Das Programm soll nun von euch gestartet werden
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item \textbf{Zusammenarbeit:} Gemeinsames Arbeiten an Projekten und Feedback sind möglich.
          \pause
    \item \textbf{Überall verfügbar:} Zugriff von verschiedenen Orten – beispielsweise an der Uni, zu Hause oder unterwegs.
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{tabular}{l l}
    ...
    \texttt{int}          & Ganzzahlen (z.\,B. 1, 2, 3)                    \\
    \texttt{float}        & Kommazahlen (weniger genau)                    \\
    \texttt{double}       & Kommazahlen (hohe Genauigkeit)                 \\
    \texttt{char}         & Einzelnes Zeichen (z.\,B. 'a')                 \\
    \texttt{short}        & Kleine Ganzzahlen                              \\
    \texttt{long}         & Große Ganzzahlen                               \\
    \texttt{boolean}      & Wahrheitswert (\texttt{true} / \texttt{false}) \\
    \texttt{String}       & Text (z.\,B. "Hallo")                          \\
  \end{tabular}
\end{frame}
...
\begin{frame}
  ...
  \begin{tabular}{l l l}
    ...
    \texttt{+}                 & Addition / Verkettung & Zahlen, String         \\
    \texttt{-}                 & Subtraktion           & Zahlen                 \\
    \texttt{*}                 & Multiplikation        & Zahlen                 \\
    \texttt{/}                 & Division              & Zahlen                 \\
    \texttt{\%}                & Modulo (Rest)         & Ganzzahlen             \\
  \end{tabular}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \vspace{0.5em}
  \begin{minted}{java}
System.out.print("Das ist eine Konsolenausgabe");
  \end{minted}
  \begin{ausgabe}
...
\begin{frame}[fragile]
  ...
  \pause
  \begin{itemize}
    \item \textbf{Syntaxfehler:} Code verletzt Java-Regeln (z.\,B. fehlendes `\texttt{;}`)
  \end{itemize}
  \begin{minted}{java}
// Fehlendes Semikolon
