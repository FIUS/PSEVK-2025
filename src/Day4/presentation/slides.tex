...
\begin{frame}[fragile]
	\frametitle{Frage 1: Wie nennt man ein Objekt, das anhand einer Klasse erstellt wurde?}
	\begin{ausgabe}
...
\begin{frame}[fragile]
	\frametitle{Frage 3: Welche Aussage(n) trifft auf Konstruktoren zu?}
	\begin{ausgabe}
		Die Funktion gibt keinen Wert zurück
	\end{ausgabe}
\end{frame}
...
\begin{frame}[fragile]
	\frametitle{Frage 4: Eine Methode innerhalb einer Klasse kann auf alle Attribute dieser Klasse zugreifen.}
	\begin{ausgabe}
		wahr
	\end{ausgabe}
	\begin{ausgabe}
